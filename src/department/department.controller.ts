...
export class DepartmentController {
    ...
    @Get('/:id')
    getDepartment(@Req() req: UserRequest, @Param('id') id: number): Promise<Department> {
        return this.departmentService.getDepartment(req, id);
    }

    @Post('/:id/follow')
    createFollow(@Req() req: UserRequest, @Param('id') id: number, @Body() followData: FollowDto): Promise<Department> {
        return this.departmentService.createFollow(req, id, followData);
    }

    @Delete('/:id/follow')
    deleteFollow(@Req() req: UserRequest, @Param('id') id: number, @Body() followData: FollowDto): Promise<Department> {
