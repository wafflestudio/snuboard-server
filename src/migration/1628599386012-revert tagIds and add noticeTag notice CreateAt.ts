...
export class revertTagIdsAndAddNoticeTagNoticeCreateAt1628599386012 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('alter table notice_tag add index `notice_cursor` (`noticeCreatedAt`, `noticeId`)');
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("alter table notice add tagIds varchar(255) not null default ''");
