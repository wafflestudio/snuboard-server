...
export class initial1612566029208 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('ALTER TABLE `user_keyword` DROP FOREIGN KEY `FK_2b3f246d4ba1da966b0aa8dfd64`');
        await queryRunner.query('ALTER TABLE `user_keyword` DROP FOREIGN KEY `FK_19dc8bfc295ce42a20018f748f6`');
        await queryRunner.query('ALTER TABLE `user_notice` DROP FOREIGN KEY `FK_210a3a2884abd3a2b63f1899977`');
        await queryRunner.query('ALTER TABLE `user_notice` DROP FOREIGN KEY `FK_f8e41a3637b784107fc82a431b5`');
        await queryRunner.query('ALTER TABLE `file` DROP FOREIGN KEY `FK_fca9b7b332e3efc00282c776e4c`');
        await queryRunner.query('ALTER TABLE `notice` DROP FOREIGN KEY `FK_a79197d19d4b3d8c1ec0e96ef68`');
        await queryRunner.query('ALTER TABLE `notice_tag` DROP FOREIGN KEY `FK_5786d9d1e48bf3048b6c1d4a4f1`');
        await queryRunner.query('ALTER TABLE `notice_tag` DROP FOREIGN KEY `FK_b10c35e2f280634dcc5184229dc`');
        await queryRunner.query('ALTER TABLE `user_tag` DROP FOREIGN KEY `FK_d1c8261be4e02dc1df64636250c`');
        await queryRunner.query('ALTER TABLE `user_tag` DROP FOREIGN KEY `FK_7cf25d8a11ccc18f04cbd8cb46c`');
        await queryRunner.query('ALTER TABLE `tag` DROP FOREIGN KEY `FK_6166aac6e5b6c0ed1a21285440b`');
        ...
        await queryRunner.query('DROP INDEX `IDX_055f16899896d15b608f001b3f` ON `notice`');
